...
/usr/local/bin/aws --profile jenkins ec2 stop-instances --instance-ids ${targets}

echo "# $(date) Waiting for targets to stop..."
/usr/local/bin/aws --profile jenkins ec2 wait instance-stopped --instance-ids ${targets}
